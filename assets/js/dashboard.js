(function(){
  ...
  const head=document.querySelector('.preview-head b'),bar=document.querySelector('.progress i');if(head)head.textContent=done+' de 8 concluídas';if(bar)bar.style.width=(done/8*100)+'%';
})();
